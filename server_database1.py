...
class ServerStorage:
    ...
    def __init__(self):
        # Создаём движок базы данных (from variables)
...
if __name__ == '__main__':
    ...
    test_db.user_login('Alex', '192.168.1.4', 8080)
    test_db.user_login('Sara', '192.168.1.5', 7777)
    ...
    test_db.user_logout('Alex')
    # И выводим список активных пользователей
    print(' ---- test_db.active_users_list() after logout Alex ----')
    print(test_db.active_users_list())

    # Запрашиваем историю входов по пользователю
    print(' ---- test_db.login_history(Alex) ----')
    print(test_db.login_history('Alex'))
