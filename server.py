...
from common.variables import ACTION, ACCOUNT_NAME, RESPONSE, MAX_CONNECTIONS, PRESENCE, TIME, USER, \
    ...
    RESPONSE_200, GET_CONTACTS, RESPONSE_202, LIST_INFO, ADD_CONTACT, REMOVE_CONTACT, USERS_REQUEST
...
from gui_server import MainWindow, gui_create_model, HistoryWindow, create_stat_model, ConfigWindow
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                server_logger.error(f'Ошибка работы с сокетами')
